...
test.describe('Mobile Typography', () => {
  ...
  test('line height is optimized for mobile readability (1.6-1.8)', async ({
    page,
    browserName,
  }) => {
  ...
  test('line length is readable on mobile (45-75 characters per line)', async ({
    page,
    browserName,
  }) => {
    test.skip(browserName !== 'chromium', 'Chromium for consistent rendering');
  ...
  test('mobile typography scales consistently across different font sizes', async ({
    page,
    browserName,
  }) => {
    test.skip(browserName !== 'chromium', 'Chromium for consistent rendering');
  ...
  test('typography remains readable during scroll and interactions', async ({
    page,
    browserName,
  }) => {
    test.skip(browserName !== 'chromium', 'Chromium for consistent rendering');
