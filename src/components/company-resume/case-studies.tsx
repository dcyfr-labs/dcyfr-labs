    ...
    <div className={SPACING.content}>
      <div className="text-center mb-12">
        ...
        <p className={`${TYPOGRAPHY.description} mt-4 max-w-3xl mx-auto`}>
          Real projects demonstrating our expertise in security architecture, modern web
          development, and AI-augmented workflows.
        </p>
      </div>
          ...
          <Card key={idx} className="p-4 md:p-5 hover:shadow-xl transition-shadow">
            <div className={SPACING.content}>
              ...
              <div>
                ...
                <p className={cn(TYPOGRAPHY.description, 'mt-2')}>{study.description}</p>
              </div>

              {/* Challenge & Solution */}
              <div className={`grid md:grid-cols-2 gap-${SPACING_SCALE.md}`}>
                <div>
                  <h4 className={cn(TYPOGRAPHY.label.small, 'mb-2 text-primary')}>Challenge</h4>
                  <p className="text-sm text-muted-foreground">{study.challenge}</p>
                </div>
                <div>
                  <h4 className={cn(TYPOGRAPHY.label.small, 'mb-2 text-primary')}>Solution</h4>
              ...
              {study.metrics && study.metrics.length > 0 && (
                <div className={`grid grid-cols-2 md:grid-cols-4 gap-${SPACING_SCALE.md}`}>
