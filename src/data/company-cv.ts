...
export const companyCV: CompanyCV = {
  overview: {
    ...
    mission:
      'Building secure, scalable solutions for modern businesses. We combine deep security expertise with modern web technologies to deliver production-grade applications that protect what matters most.',
    differentiators: [
      {
        title: 'Real-World Experience',
        description:
          '10+ years security architecture across Fortune 500 to startups, bringing battle-tested patterns to every project.',
      },
      {
        title: 'AI-Augmented Development',
        description:
          'Leverage cutting-edge AI tools to accelerate delivery without compromising quality or security.',
      },
      {
        title: 'Security by Design',
        description:
          'Security isn&apos;t an afterthought—it&apos;s built into every decision from day one.',
      },
      {
        title: 'Production-Grade Quality',
        description:
          '99% test coverage, strict design systems, comprehensive documentation—every project is production-ready.',
      },
    ],
  },
      ...
      services: [
        {
          ...
          description:
            'Comprehensive security frameworks tailored to your business needs and regulatory requirements.',
          deliverables: [
        ...
        },
        {
          ...
          description:
            'Identify, prioritize, and remediate security risks across your infrastructure and applications.',
          deliverables: [
        ...
        },
        {
          ...
          description:
            'Prepare your team to detect, respond to, and recover from security incidents effectively.',
          deliverables: [
        ...
        },
        {
          ...
          description:
            'Secure cloud deployments with zero-trust principles and defense-in-depth strategies.',
          deliverables: [
    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          description:
            'Expert code review and penetration testing to identify vulnerabilities before production.',
          deliverables: [
      ...
      services: [
        {
          ...
          description:
            'Modern, performant web applications built with the latest frameworks and best practices.',
          deliverables: [
    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          description:
            'Integrate large language models into your applications securely and efficiently.',
          deliverables: [
  ...
  caseStudies: [
    {
      ...
      description:
        'A modern, production-grade portfolio and blog platform showcasing cyber architecture expertise.',
      challenge:
        'Build a high-performance, secure platform to showcase technical expertise while demonstrating best practices in web development and security.',
      solution:
        'Implemented a Next.js 16 application with React 19, featuring a comprehensive design system, 99% test coverage, automated security scanning, and AI-powered content management.',
      results: [
      ...
      links: [
        ...
        { label: 'Source Code', href: 'https://github.com/dcyfr-labs/dcyfr-labs', type: 'github' },
      ],
    },
    {
      ...
      challenge:
        'Manual security reviews were slowing down development velocity and missing critical vulnerabilities.',
      solution:
        'Implemented automated CodeQL analysis, Dependabot auto-merge for safe updates, custom LGTM suppressions for false positives, and continuous security monitoring with Sentry integration.',
      results: [
    ...
    },
    {
      ...
      description:
        'Custom AI agents and tooling accelerating feature development by 3x without sacrificing quality.',
      challenge:
        'Balancing development speed with code quality, security, and comprehensive testing.',
      solution:
        'Created specialized Claude Code agents for production enforcement, quick fixes, and test coverage. Integrated MCP servers for Sentry, Axiom, and GitHub. Implemented design token enforcement system.',
      results: [
  ...
  valuePropositions: [
    {
      title: 'Real-World Experience',
      description:
        'Over a decade of security architecture across diverse industries and company sizes.',
      benefits: [
    ...
    },
    {
      ...
      description:
        'Cutting-edge frameworks and best practices for scalable, maintainable solutions.',
      benefits: [
