...
import { GET } from '@/app/api/credly/badges/route';
...
describe('Credly Badges API Route', () => {
  ...
  it('uses custom username from query parameter', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/credly/badges?username=testuser');
    await GET(request);
  ...
  it('limits results when limit parameter is provided', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/credly/badges?limit=3');
    const response = await GET(request);
    const data = await response.json();
...
describe('SSRF Security Tests - CWE-918 Prevention', () => {
  ...
  describe('Special Character & Encoding Prevention', () => {
    ...
    it('should accept username with ampersand if used as a valid part of username', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/credly/badges?username=user-name');
      const response = await GET(request);
  ...
  describe('Valid Username Patterns', () => {
    it('should accept alphanumeric username', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/credly/badges?username=dcyfr123');
      const response = await GET(request);
    ...
    it('should accept username with hyphens', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/credly/badges?username=john-doe');
      const response = await GET(request);
    ...
    it('should accept username with underscores', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/credly/badges?username=john_doe');
      const response = await GET(request);
  ...
  describe('URL Construction Verification', () => {
    it('should always use HTTPS protocol', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/credly/badges?username=dcyfr');
      await GET(request);
    ...
    it('should properly encode username in path', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/credly/badges?username=user123');
      await GET(request);
