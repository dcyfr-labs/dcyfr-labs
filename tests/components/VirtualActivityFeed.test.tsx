...
describe('VirtualActivityFeed', () => {
  describe('Loading & Empty States', () => {
    ...
    it('renders custom empty message', () => {
      render(<VirtualActivityFeed items={[]} emptyMessage="Custom empty message" />);
  ...
  describe('Rendering', () => {
    it('renders with activities without crashing', () => {
      const { container } = render(<VirtualActivityFeed items={mockActivities} />);
      expect(container).toBeTruthy();
      expect(screen.queryByText('No recent activity')).not.toBeInTheDocument();
    });

    it('renders with groups', () => {
      const { container } = render(<VirtualActivityFeed items={mockActivities} showGroups />);
      expect(container).toBeTruthy();
    });
  ...
  describe('Infinite Scroll', () => {
    ...
    it('renders loading indicator when isLoadingMore', () => {
      render(
        <VirtualActivityFeed items={mockActivities} enableInfiniteScroll hasMore isLoadingMore />
      );
