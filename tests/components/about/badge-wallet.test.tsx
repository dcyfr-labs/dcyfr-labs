...
const mockBadges: CredlyBadge[] = [
  {
    ...
    badge_template: {
      ...
      skills: [{ id: 'skill-1', name: 'Cybersecurity', vanity_slug: 'cybersecurity' }],
    },
    image_url: 'https://images.credly.com/badge1.png',
  ...
  },
  {
    ...
    badge_template: {
      ...
      skills: [{ id: 'skill-2', name: 'Cloud Architecture', vanity_slug: 'cloud-architecture' }],
    },
    image_url: 'https://images.credly.com/badge2.png',
...
describe('BadgeWallet', () => {
  ...
  it('applies custom className', () => {
    ...
    const { container } = render(<BadgeWallet username="dcyfr" className="custom-class" />);
