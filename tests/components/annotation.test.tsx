...
describe('Annotation Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should apply custom className', () => {
      const { container } = render(<Annotation className="custom-class">Test</Annotation>);
...
describe('AnnotationVariants', () => {
  ...
  it('should pass additional props to variants', () => {
    render(<AnnotationVariants.Highlight strokeWidth={5}>Test</AnnotationVariants.Highlight>);
