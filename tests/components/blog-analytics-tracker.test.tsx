...
describe('BlogAnalyticsTracker', () => {
  ...
  describe('Post Data Variations', () => {
    it('handles post with single tag', () => {
      ...
      expect(mockTrackBlogView).toHaveBeenCalledWith('test-post', 'Test Blog Post', ['single'], 5);
    });
    ...
    it('handles post with no tags', () => {
      ...
      expect(mockTrackBlogView).toHaveBeenCalledWith('test-post', 'Test Blog Post', [], 5);
    });
    ...
    it('handles post with many tags', () => {
      ...
      expect(mockTrackBlogView).toHaveBeenCalledWith('test-post', 'Test Blog Post', manyTags, 5);
    });
