...
describe('DownloadableAsset', () => {
  ...
  describe('Rendering', () => {
    it('should render with title', () => {
      render(<DownloadableAsset title="Test Document" fileUrl="/test.pdf" fileName="test.pdf" />);
  ...
  describe('Download With Email', () => {
    ...
    it('should show error when email is empty', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Email is required to download this file')).toBeInTheDocument();
      });
    });
    ...
    it('should clear error when typing after validation failure', async () => {
      ...
      expect(screen.queryByText('Email is required to download this file')).not.toBeInTheDocument();
    });
