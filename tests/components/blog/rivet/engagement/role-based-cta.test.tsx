...
describe('RoleBasedCTA', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render with correct role-specific classes for developer', () => {
      const { container } = render(<RoleBasedCTA {...defaultProps} role="developer" />);
    ...
    it('should render with correct role-specific classes for security', () => {
      const { container } = render(<RoleBasedCTA {...defaultProps} role="security" />);
  ...
  describe('Button Functionality', () => {
    ...
    it('should support custom button href', () => {
      render(<RoleBasedCTA {...defaultProps} buttonHref="/custom-path?role=dev" />);
  ...
  describe('Props Validation', () => {
    it('should handle empty description', () => {
      render(<RoleBasedCTA {...defaultProps} description="" />);
    ...
    it('should handle very long title', () => {
      ...
      render(<RoleBasedCTA {...defaultProps} title={longTitle} />);
    ...
    it('should accept custom className', () => {
      const { container } = render(<RoleBasedCTA {...defaultProps} className="custom-class" />);
  ...
  describe('Analytics Integration', () => {
    it('should include button text in analytics', () => {
      ...
      render(<RoleBasedCTA {...defaultProps} buttonText="Schedule Assessment" />);
    ...
    it('should include role in analytics', () => {
      ...
      render(<RoleBasedCTA {...defaultProps} role="developer" />);
  ...
  describe('Icon Rendering', () => {
    it('should render briefcase icon for executive', () => {
      const { container } = render(<RoleBasedCTA {...defaultProps} role="executive" />);
