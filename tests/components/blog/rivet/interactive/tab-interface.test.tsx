...
describe('TabInterface', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should apply custom className', () => {
      const { container } = render(<TabInterface tabs={defaultTabs} className="custom-class" />);
  ...
  describe('Variants', () => {
    it('should render with default variant', () => {
      const { container } = render(<TabInterface tabs={defaultTabs} variant="default" />);
    ...
    it('should render with pills variant', () => {
      const { container } = render(<TabInterface tabs={defaultTabs} variant="pills" />);
    ...
    it('should render with underline variant', () => {
      const { container } = render(<TabInterface tabs={defaultTabs} variant="underline" />);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle empty content', () => {
      const emptyContentTab: TabItem[] = [{ id: 'empty', label: 'Empty', content: null }];
