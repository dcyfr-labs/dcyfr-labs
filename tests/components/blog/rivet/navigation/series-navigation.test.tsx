...
import {
  SeriesNavigation,
  type SeriesItem,
} from '@/components/blog/rivet/navigation/series-navigation';
...
describe('SeriesNavigation', () => {
  ...
  describe('All Parts List', () => {
    ...
    it('should highlight current item in all parts list', () => {
      ...
      const currentLink = screen.getByText('Part 2: Getting Started').closest('a');
  ...
  describe('Accessibility', () => {
    ...
    it('should have accessible progress bar', () => {
      ...
      const progressBar = container.querySelector('[role="progressbar"]');
      expect(progressBar).toHaveAttribute('aria-label', 'Series progress: 1 of 3 completed');
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long titles', () => {
      ...
      expect(screen.getByText(/A Very Long Title That Should Be Truncated/)).toBeInTheDocument();
    });
