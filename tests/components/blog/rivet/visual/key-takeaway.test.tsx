...
describe('KeyTakeaway', () => {
  ...
  describe('Variants', () => {
    it('renders insight variant with correct styles', () => {
      const { container } = render(<KeyTakeaway variant="insight">Insight content</KeyTakeaway>);
    ...
    it('renders security variant with correct styles', () => {
      const { container } = render(<KeyTakeaway variant="security">Security content</KeyTakeaway>);
      const noteElement = container.querySelector('[role="note"]');
    ...
    it('renders warning variant with correct styles', () => {
      const { container } = render(<KeyTakeaway variant="warning">Warning content</KeyTakeaway>);
      const noteElement = container.querySelector('[role="note"]');
    ...
    it('renders tip variant with correct styles', () => {
      const { container } = render(<KeyTakeaway variant="tip">Tip content</KeyTakeaway>);
      const noteElement = container.querySelector('[role="note"]');
  ...
  describe('Icons', () => {
    it('renders icon for insight variant', () => {
      const { container } = render(<KeyTakeaway variant="insight">Content</KeyTakeaway>);
    ...
    it('renders icon for security variant', () => {
      const { container } = render(<KeyTakeaway variant="security">Content</KeyTakeaway>);
      const icon = container.querySelector('svg');
      expect(icon).toBeInTheDocument();
    ...
    it('renders icon for warning variant', () => {
      const { container } = render(<KeyTakeaway variant="warning">Content</KeyTakeaway>);
      const icon = container.querySelector('svg');
      expect(icon).toBeInTheDocument();
    ...
    it('renders icon for tip variant', () => {
      const { container } = render(<KeyTakeaway variant="tip">Content</KeyTakeaway>);
      const icon = container.querySelector('svg');
      expect(icon).toBeInTheDocument();
  ...
  describe('Custom className', () => {
    it('applies custom className', () => {
      const { container } = render(<KeyTakeaway className="custom-class">Content</KeyTakeaway>);
