...
describe('RiskMatrix', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should apply custom className', () => {
      const { container } = render(<RiskMatrix risks={defaultRisks} className="custom-matrix" />);
  ...
  describe('Interactive Features', () => {
    ...
    it('should not be interactive when interactive is false', () => {
      const { container } = render(<RiskMatrix risks={defaultRisks} interactive={false} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long risk names', async () => {
      const longNameRisks: RiskItem[] = [
        {
          id: 'r1',
          name: 'This is a very long risk name that should still be handled correctly in the visualization and dialog'.repeat(
            2
          ),
          likelihood: 'high',
          impact: 'high',
