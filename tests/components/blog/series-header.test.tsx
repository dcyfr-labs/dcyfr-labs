...
describe('SeriesHeader', () => {
  it('should render series title', () => {
    render(<SeriesHeader name="React Hooks Deep Dive" postCount={5} totalMinutes={28} />);
    expect(screen.getByText('React Hooks Deep Dive')).toBeInTheDocument();
  });

  it('should display singular post count correctly', () => {
    render(<SeriesHeader name="Test Series" postCount={1} totalMinutes={5} />);
    expect(screen.getByText('1 post')).toBeInTheDocument();
  });

  it('should display plural post count correctly', () => {
    render(<SeriesHeader name="Test Series" postCount={5} totalMinutes={28} />);
  ...
  it('should display singular reading time correctly', () => {
    render(<SeriesHeader name="Test Series" postCount={1} totalMinutes={1} />);
