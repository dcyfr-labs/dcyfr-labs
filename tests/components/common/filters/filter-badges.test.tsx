...
describe('FilterBadges', () => {
  ...
  it('should render all badge items', () => {
    ...
    render(<FilterBadges items={mockItems} selected={[]} onToggle={onToggle} />);
  ...
  it('should return null when items array is empty', () => {
    const onToggle = vi.fn();
    const { container } = render(<FilterBadges items={[]} selected={[]} onToggle={onToggle} />);
  ...
  it('should highlight selected badges', () => {
    const onToggle = vi.fn();
    render(
      <FilterBadges items={mockItems} selected={['react', 'typescript']} onToggle={onToggle} />
    );
  ...
  it('should show X icon on selected badges', () => {
    const onToggle = vi.fn();
    render(<FilterBadges items={mockItems} selected={['react']} onToggle={onToggle} />);
  ...
  it('should render icon when provided', () => {
    const onToggle = vi.fn();
    render(<FilterBadges items={mockItems} selected={[]} onToggle={onToggle} icon={Tags} />);
  ...
  it('should render label when provided', () => {
    const onToggle = vi.fn();
    render(<FilterBadges items={mockItems} selected={[]} onToggle={onToggle} label="Categories" />);
