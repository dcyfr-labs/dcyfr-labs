...
describe('HeroOverlay Component', () => {
  ...
  describe('Intensity Levels', () => {
    ...
    it('should vary intensity height based on direction', () => {
      const topLight = render(<HeroOverlay intensity="light" direction="top" />).container
        .firstChild as HTMLElement;
      const topMedium = render(<HeroOverlay intensity="medium" direction="top" />).container
        .firstChild as HTMLElement;
      const topStrong = render(<HeroOverlay intensity="strong" direction="top" />).container
        .firstChild as HTMLElement;
        ...
        intensities.forEach((intensity) => {
          it(`should render ${variant}/${direction}/${intensity} without error`, () => {
            const { container } = render(
              <HeroOverlay variant={variant} direction={direction} intensity={intensity} />
            );
            expect(container.firstChild).toBeTruthy();
            const overlay = container.firstChild as HTMLElement;
            expect(overlay.className).toBeTruthy();
