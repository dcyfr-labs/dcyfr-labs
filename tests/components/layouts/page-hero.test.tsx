...
describe('PageHero', () => {
  ...
  describe('Variants', () => {
    ...
    it('renders homepage variant', () => {
      render(
        <PageHero variant="homepage" title="Homepage Title" description="Homepage Description" />
      );
    ...
    it('renders article variant', () => {
      render(
        <PageHero variant="article" title="Article Title" description="Article Description" />
      );
  ...
  describe('Alignment', () => {
    ...
    it('renders with center alignment', () => {
      render(<PageHero title="Centered Title" description="Centered Description" align="center" />);
  ...
  describe('Optional Elements', () => {
    it('renders with image', () => {
      render(
        <PageHero
          ...
          description="Description"
          image={
            <div data-testid="hero-image" role="img" aria-label="Avatar">
              Avatar Image
            </div>
          }
        />
    ...
    it('renders with itemCount', () => {
      render(<PageHero title="Blog Posts" description="All posts" itemCount={42} />);
  ...
  describe('Custom Classes', () => {
    it('applies custom className to container', () => {
      const { container } = render(
        <PageHero title="Title" description="Description" className="custom-hero" />
      );
    ...
    it('applies custom contentClassName', () => {
      render(
        <PageHero title="Title" description="Description" contentClassName="custom-content" />
      );
  ...
  describe('Loading State', () => {
    ...
    it('does not render title/description when loading', () => {
      render(<PageHero loading title="Should not appear" description="Should not appear" />);
  ...
  describe('Edge Cases', () => {
    ...
    it('renders with only image', () => {
      render(<PageHero image={<div data-testid="only-image">Image Only</div>} />);

      expect(screen.getByTestId('only-image')).toBeInTheDocument();
    });

    it('renders with only actions', () => {
      render(<PageHero actions={<button data-testid="only-action">Action Only</button>} />);
    ...
    it('maintains semantic structure with image and content', () => {
      const { container } = render(
        <PageHero
          ...
          description="Description"
          image={
            <div data-testid="test-image" role="img" aria-label="Test">
              Test Image
            </div>
          }
        />
