...
describe('useDropdown', () => {
  ...
  describe('controlled mode', () => {
    it('should use controlled state when isOpen is provided', () => {
      ...
      const { result } = renderHook(() => useDropdown({ isOpen: true, onOpenChange }));
    ...
    it('should call onOpenChange when toggle is called', () => {
      const onOpenChange = vi.fn();
      const { result } = renderHook(() => useDropdown({ isOpen: false, onOpenChange }));
  ...
  describe('escape key handling', () => {
    ...
    it('should not close when Escape is pressed and closeOnEscape is false', () => {
      const { result } = renderHook(() => useDropdown({ defaultOpen: true, closeOnEscape: false }));
  ...
  describe('cleanup', () => {
    it('should cleanup click listener on unmount', () => {
      const { result, unmount } = renderHook(() => useDropdown({ defaultOpen: true }));
    ...
    it('should cleanup escape listener on unmount', () => {
      const { unmount } = renderHook(() => useDropdown({ defaultOpen: true }));
