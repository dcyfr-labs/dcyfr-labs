...
describe('extractTopics', () => {
  ...
  it('should extract keywords from titles when enabled', () => {
    const activities = [
      createMockActivity('1', [], undefined, 'Building Apps with TypeScript'),
  ...
  it('should exclude stop words from keyword extraction', () => {
    const activities = [createMockActivity('1', [], undefined, 'The Best Way to Learn React')];
  ...
  it('should handle activities with no topics', () => {
    const activities = [createMockActivity('1', undefined, undefined, 'No tags')];
...
describe('getRelatedTopics', () => {
  ...
  it('should limit number of related topics', () => {
    const activities = [createMockActivity('1', ['A', 'B', 'C', 'D', 'E', 'F'])];
  ...
  it('should normalize topic name in lookup', () => {
    const activities = [createMockActivity('1', ['TypeScript', 'React'])];
...
describe('getActivityTopics', () => {
  it('should get all topics for an activity', () => {
    const activity = createMockActivity('1', ['TypeScript', 'React'], 'Web Development');
  ...
  it('should deduplicate topics', () => {
    const activity = createMockActivity('1', ['TypeScript', 'typescript'], 'TypeScript');
