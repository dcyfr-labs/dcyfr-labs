...
describe('Referral Tracker', () => {
  describe('detectReferralSource', () => {
    ...
    it('should detect Twitter/X referral from x.com domain', () => {
      const result = detectReferralSource('https://x.com/user/status/123', '');
    ...
    it('should detect DEV referral', () => {
      const result = detectReferralSource('https://dev.to/dcyfr/my-article', '');
    ...
    it('should detect LinkedIn referral', () => {
      const result = detectReferralSource('https://www.linkedin.com/feed/', '');
    ...
    it('should detect Reddit referral', () => {
      const result = detectReferralSource('https://www.reddit.com/r/programming/', '');
    ...
    it('should detect Hacker News referral', () => {
      const result = detectReferralSource('https://news.ycombinator.com/item?id=123', '');
    ...
    it('should detect GitHub referral', () => {
      const result = detectReferralSource('https://github.com/dcyfr/repo', '');
    ...
    it('should return other for unknown referrer', () => {
      const result = detectReferralSource('https://unknown-site.com', '');
