...
describe('Security Version Checker', () => {
  ...
  describe('checkAdvisoryImpact', () => {
    ...
    it('should identify non-vulnerable installed versions', () => {
      const result = checkAdvisoryImpact('next', '< 16.0.7', '16.0.7', mockLockData);
    ...
    it('should identify vulnerable installed versions', () => {
      const result = checkAdvisoryImpact('next', '>= 16.0.0, < 16.0.7', '16.0.7', {
    ...
    it('should handle missing installed version', () => {
      const result = checkAdvisoryImpact('nonexistent', '< 1.0.0', '1.0.0', mockLockData);
    ...
    it('should handle missing vulnerable range', () => {
      const result = checkAdvisoryImpact('next', '', '16.0.7', mockLockData);
    ...
    it('should handle missing patched version', () => {
      const result = checkAdvisoryImpact('next', '< 16.0.7', 'Not available', mockLockData);
    ...
    it('should be conservative when both range and version are missing', () => {
      const result = checkAdvisoryImpact('next', '', '', mockLockData);
  ...
  describe('Integration scenarios', () => {
    it('should correctly evaluate real-world scenario: CVE-2025-55182 false positive', () => {
      ...
      const result = checkAdvisoryImpact('next', '< 16.0.7', '16.0.7', lockData);
