...
const mockProjects: Project[] = [
  {
    ...
    links: [{ label: 'GitHub', href: 'https://github.com/testuser/active-repo', type: 'github' }],
    featured: true,
  ...
  },
  {
    ...
    links: [{ label: 'Demo', href: 'https://example.com/demo', type: 'demo' }],
...
describe('getTrendingProjects', () => {
  ...
  describe('GitHub Data Fetching', () => {
    ...
    it('should handle various GitHub URL formats gracefully', async () => {
      const projectWithGitSuffix: Project = {
        ...mockProjects[0],
        links: [{ label: 'GitHub', href: 'https://github.com/testuser/repo.git', type: 'github' }],
      };
  ...
  describe('Scoring Algorithm', () => {
    it('should calculate scores based on stars, forks, and recency', async () => {
      ...
      const result = await getTrendingProjects([mockProjects[0], mockProjects[1]], { limit: 2 });
