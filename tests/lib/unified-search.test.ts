...
describe('getMatchExcerpt', () => {
  const longText =
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit. TypeScript is a great language for building scalable applications. It provides type safety and better tooling.';
